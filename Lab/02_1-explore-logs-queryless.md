...
このラボでは、必要なログをすばやく見つけるのに役立つ Logs Drilldown の基本機能を確認します。一部のユーザーから、Web サイトで favicon が表示されないという報告が寄せられています。その原因を一緒に調べてみましょう。
...
3. 次に **Logs** タブをクリックして、ログ一覧に戻ります。
    ...
    選択した `http_method` ラベル値を持つログだけに、さらに絞り込まれていることが確認できます。
